...
- 77.尝试给 mall 的查询添加索引优化

- 78.自己用过的框架都写个博客，例如 winston 等等

- 79.优化上传工具，添加记忆功能，做成 electron 集成
...
- 91.思考一下几个微服务的公共方法如何管理

- 92.搭个高速梯子

- 93.慢慢把 docker 和 jenkins 集成到发版工具中
...
- 107.用中间件优化 createdTime，并且提取公共库，校验也可以做成公共的中间件
