...
我们还是以 [实战案例 - feature-communication-shared 分支](https://github.com/a1029563229/micro-front-template/tree/feature-communication-shared) 的 `登录流程` 为例，给大家展示如何使用 `Shared` 进行应用间通信。
...
![micro-app](http://shadows-mall.oss-cn-shenzhen.aliyuncs.com/images/blogs/caddy/12.png)

![micro-app](http://shadows-mall.oss-cn-shenzhen.aliyuncs.com/images/blogs/caddy/13.png)
...
![micro-app](http://shadows-mall.oss-cn-shenzhen.aliyuncs.com/images/blogs/caddy/14.png)
